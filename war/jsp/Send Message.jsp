...
<form action="/social/Notify" method="POST">
 ...
 Message Text : <input type="text"  style="border-radius:20px;border:3px solid black ; width: 200px;margin-top:5%; margin-bottom:3%; margin-left:20%; margin-right:10% " name="msg" /> <br>
